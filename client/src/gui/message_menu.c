...
void edit_button_click(GtkWidget *widget, t_msg *message) {
    ...
    g_signal_handler_unblock(send_btn, g_signal_handler_find(send_btn, G_SIGNAL_MATCH_FUNC, 0, 0, NULL, send_button_click, NULL));
    g_signal_handler_disconnect(send_btn, g_signal_handler_find(send_btn, G_SIGNAL_MATCH_FUNC, 0, 0, NULL, edit_button_click, NULL)); 
    g_signal_handler_disconnect(new_message_field, g_signal_handler_find(new_message_field, G_SIGNAL_MATCH_FUNC, 0, 0, NULL, edit_button_click, NULL)); 
    g_signal_handler_unblock(new_message_field, g_signal_handler_find(new_message_field, G_SIGNAL_MATCH_FUNC, 0, 0, NULL, send_button_click, NULL));
...
void edit_message(GtkWidget *widget, GdkEventButton *event, t_msg *message) {
    ...
    g_signal_handler_block(widget, g_signal_handler_find(widget, G_SIGNAL_MATCH_FUNC, 0, 0, NULL, edit_message, NULL));

    g_signal_handler_block(send_btn, g_signal_handler_find(send_btn, G_SIGNAL_MATCH_FUNC, 0, 0, NULL, send_button_click, NULL));
    g_signal_handler_block(new_message_field, g_signal_handler_find(new_message_field, G_SIGNAL_MATCH_FUNC, 0, 0, NULL, send_button_click, NULL));
